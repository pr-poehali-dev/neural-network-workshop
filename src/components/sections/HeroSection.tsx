    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className={`container mx-auto px-4 relative z-10 text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="mb-12 px-4 animate-slide-up-fade" style={{ animationDelay: '0.5s', animationFillMode: 'both' }}>
          <div className="inline-flex flex-col md:flex-row items-center gap-4 bg-gradient-to-r from-secondary/20 via-primary/20 to-secondary/20 backdrop-blur-sm border-2 border-primary/40 rounded-lg px-6 py-4 shadow-[0_0_20px_rgba(0,255,153,0.15)] hover:shadow-[0_0_30px_rgba(0,255,153,0.25)] hover:scale-[1.02] transition-all duration-500">
            <img 
