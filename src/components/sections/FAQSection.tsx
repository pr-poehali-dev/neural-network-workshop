...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Нет, записей не делаем. Только живое участие для максимального вовлечения и интерактива.'
    },
    {
    ...
    {
      question: 'Что если я не смогу присутствовать?',
      answer: 'Не проблема! Зарегистрируйтесь, и мы пригласим вас на повтор мероприятия.'
    }
  ];
